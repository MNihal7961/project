                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <% if (order.orderStatus === "Pending") { %>
                          <li value="Processing">
                            <a class="dropdown-item" onclick="orderProcess('<%- order._id %>','Processing')">
                        ...
                        <% if (order.orderStatus === "Processing") { %>
                          <li value="Placed">
                            <a class="dropdown-item" onclick="orderPlace('<%- order._id %>','Placed')">
                        ...
                        <% if (order.orderStatus === "Placed") { %>
                          <li value="Shipped" aria-disabled="true">
                            <a class="dropdown-item" onclick="orderShip('<%- order._id %>','Shipped')">
                        ...
                        <% if (order.orderStatus === "Shipped") { %>
                          <li value="Delivered" onclick="orderDelivery('<%- order._id %>','Delivered')">
